...
class Student:
    ...
    def displayGPA(self):
        gpa = 0.0
        #check for not empty course dictionary before calculating average; if empty
    ...
    def displayCourses(self):
        # save a list to return
        courses_passed = []
        # iterate on dictionary; append courses with grades higher than 0 to passed courses list
